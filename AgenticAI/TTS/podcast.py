...
research_paper = PDFKnowledgeSource(file_paths="./pdf/attention.pdf" , 
chunk_size=4000,
chunk_overlap=200,
)
...
class DialogueLine(BaseModel):
    ...
    speaker: str = Field(..., description="Name of the speaker (Sarah or Simo)")
...
if __name__ == "__main__":    
    ...
    results = crew.kickoff(inputs={"paper": "./pdf/attention.pdf"})